...
//    private lateinit var loginViewModel: LoginViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        (application as CardApplication).appComponent.injectLogin(this)
...
//            .get(LoginViewModel::class.java)
        ...
        viewModel.loginFormState.observe(this@AuthorizationActivity, Observer {
        ...
        viewModel.loginResult.observe(this@AuthorizationActivity, Observer {
